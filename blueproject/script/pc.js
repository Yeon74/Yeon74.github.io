...
$aboutMsg.forEach((msg) => {
    gsap.from(msg, {
        ...
        scrollTrigger: {
            trigger: msg,
            containerAnimation: horizonScroll, //꼭? 필수 가로스크롤일경우
            start: 'left 90%',
...
//skills 에서 h2태그는 커진상태에서 작아지며서 안보이게
gsap.to("#skills>h2", {
    opacity: 0,
    scale: 0.5,
    duration: 2,
